...
export const Menubar = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, menubarProps<T>>) => {
  ...
  return (
    <MenubarPrimitive
      class={cn('bg-background flex h-9 items-center space-x-1 rounded-md border p-1 shadow-sm', local.class)}
      {...rest}
    />
  );
};
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.SubContent
        class={cn(
          'bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95 animate-duration-50) data-[closed]:(animate-out fade-out-0 zoom-out-95) z-50 min-w-[8rem] origin-[--kb-menu-content-transform-origin] overflow-hidden rounded-md border p-1 shadow-lg outline-none',
          local.class
        )}
        {...rest}
      >
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        class={cn(
          'bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95 animate-duration-50) data-[closed]:(animate-out fade-out-0 zoom-out-95) z-50 min-w-[12rem] origin-[--kb-menu-content-transform-origin] overflow-hidden rounded-md border p-1 shadow-md outline-none',
          local.class
        )}
        {...rest}
      >
...
export const MenubarSeparator = <T extends ValidComponent = 'hr'>(
  ...
  return <MenubarPrimitive.Separator class={cn('bg-muted -mx-1 my-1 h-px', local.class)} {...rest} />;
};
...
export const MenubarShortcut = (props: ComponentProps<'span'>) => {
  ...
  return <span class={cn('text-muted-foreground ml-auto text-xs tracking-widest', local.class)} {...rest} />;
};
