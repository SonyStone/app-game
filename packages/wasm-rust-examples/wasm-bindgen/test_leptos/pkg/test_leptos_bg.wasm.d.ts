...
export function __wbg_leptoselement_free(a: number, b: number): void;
export function leptoselement_new(): number;
export function leptoselement_element(a: number): number;
...
export function closure157_externref_shim(a: number, b: number, c: number): void;
export function __externref_table_alloc(): number;
export function __wbindgen_exn_store(a: number): void;
export function closure168_externref_shim(a: number, b: number, c: number, d: number): void;
