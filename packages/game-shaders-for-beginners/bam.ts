...
// conversion.
export const _bam_header = 'pbj\0\n\r';

export const _bam_major_ver = 6;
...
export const _bam_first_minor_ver = 14;
export const _bam_last_minor_ver = 45;
export const _bam_minor_ver = 44;
