...
const routes: Routes[] = [
  {
    ...
    component: lazy(() => import('./SolidThreeExample'))
  },
  {
    path: '/three-pixi',
  ...
  },
  {
    ...
    name: 'SolidThree',
    Preview: (props) => <Thumbnail href={props.path} name={props.name} />,
    component: lazy(() => import('./Solid-Three'))
  },
  {
    path: '/view-offset',
    name: 'ViewOffset',
    Preview: (props) => <Thumbnail href={props.path} name={props.name} />,
    component: lazy(() => import('./ViewOffset'))
  }
];
