...
const asd = (props: {
  ...
  function attachListeners(element: MinimumPointerEventTarget): VoidFunction {
    ...
    return () => {
      element.removeEventListener('pointermove', props.onPointerMove);
      element.removeEventListener('pointerup', props.onPointerUp);
      element.removeEventListener('pointercancel', props.onPointerCancel);
      element.removeEventListener('lostpointercapture', props.onLostCapture);
    };
  }
};
...
export function createCapture(props: {
  ...
  return {
    ...
    set(element: MinimumPointerEventTarget, pointerId: number) {
      if (capturedElement) {
        release();
      }
