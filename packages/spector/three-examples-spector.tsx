...
import { SpectorIframe } from './spector-iframe';

const THREE_EXAMPLES_URL = 'https://threejs.org/examples/';
const DEFAULT_EXAMPLE = 'webgl_postprocessing_unreal_bloom';

/** Loads the official Three.js WebGL catalog and captures whichever example is selected. */
export function ThreeExamplesSpector(): JSX.Element {
