...
import { CommandCapturedCallbacks, ICommandCapture } from '../../shared/capture/commandCapture';
...
export class StateSpy {
  ...
  startCapture(currentCapture: ICapture, quickCapture: boolean, fullCapture: boolean): void {
