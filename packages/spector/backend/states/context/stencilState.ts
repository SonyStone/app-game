...
export class StencilState extends ParameterState {
  static readonly stateName = 'StencilState';
  ...
  private static stencilOpStates = [
    WebGlConstants.STENCIL_BACK_FAIL.value,
  ...
  private static stencilFuncStates = [
    WebGlConstants.STENCIL_BACK_FUNC.value,
  ...
  private static stencilMaskStates = [
    WebGlConstants.STENCIL_BACK_WRITEMASK.value,
    WebGlConstants.STENCIL_WRITEMASK.value
  ];

  protected getWebgl1Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.STENCIL_TEST, changeCommands: ['enable', 'disable'] },
      {
        constant: WebGlConstants.STENCIL_BACK_FAIL,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_BACK_FUNC,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilFunc', 'stencilFuncSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_BACK_PASS_DEPTH_FAIL,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_BACK_PASS_DEPTH_PASS,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      { constant: WebGlConstants.STENCIL_BACK_REF, changeCommands: ['stencilFunc', 'stencilFuncSeparate'] },
      {
        constant: WebGlConstants.STENCIL_BACK_VALUE_MASK,
        returnType: ParameterReturnType.GlUint,
        changeCommands: ['stencilFunc', 'stencilFuncSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_BACK_WRITEMASK,
        returnType: ParameterReturnType.GlUint,
        changeCommands: ['stencilMask', 'stencilMaskSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_FAIL,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_FUNC,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilFunc', 'stencilFuncSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_PASS_DEPTH_FAIL,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_PASS_DEPTH_PASS,
        returnType: ParameterReturnType.GlEnum,
        changeCommands: ['stencilOp', 'stencilOpSeparate']
      },
      { constant: WebGlConstants.STENCIL_REF, changeCommands: ['stencilFunc', 'stencilFuncSeparate'] },
      {
        constant: WebGlConstants.STENCIL_VALUE_MASK,
        returnType: ParameterReturnType.GlUint,
        changeCommands: ['stencilFunc', 'stencilFuncSeparate']
      },
      {
        constant: WebGlConstants.STENCIL_WRITEMASK,
        returnType: ParameterReturnType.GlUint,
        changeCommands: ['stencilMask', 'stencilMaskSeparate']
      }
    ];
