...
export class AlignmentState extends ParameterState {
  static readonly stateName = 'AlignmentState';
  ...
  protected getWebgl1Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.PACK_ALIGNMENT, changeCommands: ['pixelStorei'] },
      { constant: WebGlConstants.UNPACK_ALIGNMENT, changeCommands: ['pixelStorei'] },
      {
        constant: WebGlConstants.UNPACK_COLORSPACE_CONVERSION_WEBGL,
  ...
  protected getWebgl2Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.PACK_ROW_LENGTH, changeCommands: ['pixelStorei'] },
