...
export class CoverageState extends ParameterState {
  static readonly stateName = 'CoverageState';
  ...
  protected getWebgl1Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.SAMPLE_COVERAGE_VALUE, changeCommands: ['sampleCoverage'] },
  ...
  protected getWebgl2Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.SAMPLE_COVERAGE, changeCommands: ['enable', 'disable'] },
