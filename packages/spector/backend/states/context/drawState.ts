...
export class DrawState extends ParameterState {
  static readonly stateName = 'DrawState';
  ...
  protected getWebgl1Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.DITHER, changeCommands: ['enable', 'disable'] },
  ...
  protected getWebgl2Parameters(): IParameter[] {
    return [
      { constant: WebGlConstants.RASTERIZER_DISCARD, changeCommands: ['enable', 'disable'] },
