...
export class WebGlConstants {
  ...
  static readonly STENCIL_VALUE_MASK: WebGlConstant = { name: 'STENCIL_VALUE_MASK', value: 2963, description: ' ' };
  static readonly STENCIL_WRITEMASK: WebGlConstant = { name: 'STENCIL_WRITEMASK', value: 2968, description: ' ' };
  static readonly STENCIL_BACK_FUNC: WebGlConstant = { name: 'STENCIL_BACK_FUNC', value: 34816, description: ' ' };
  static readonly STENCIL_BACK_FAIL: WebGlConstant = { name: 'STENCIL_BACK_FAIL', value: 34817, description: ' ' };
  ...
  static readonly STENCIL_BACK_REF: WebGlConstant = { name: 'STENCIL_BACK_REF', value: 36003, description: ' ' };
  ...
  static readonly COLOR_CLEAR_VALUE: WebGlConstant = { name: 'COLOR_CLEAR_VALUE', value: 3106, description: ' ' };
  static readonly COLOR_WRITEMASK: WebGlConstant = { name: 'COLOR_WRITEMASK', value: 3107, description: ' ' };
  static readonly UNPACK_ALIGNMENT: WebGlConstant = { name: 'UNPACK_ALIGNMENT', value: 3317, description: ' ' };
  static readonly PACK_ALIGNMENT: WebGlConstant = { name: 'PACK_ALIGNMENT', value: 3333, description: ' ' };
  static readonly MAX_TEXTURE_SIZE: WebGlConstant = { name: 'MAX_TEXTURE_SIZE', value: 3379, description: ' ' };
  static readonly MAX_VIEWPORT_DIMS: WebGlConstant = { name: 'MAX_VIEWPORT_DIMS', value: 3386, description: ' ' };
  static readonly SUBPIXEL_BITS: WebGlConstant = { name: 'SUBPIXEL_BITS', value: 3408, description: ' ' };
  static readonly RED_BITS: WebGlConstant = { name: 'RED_BITS', value: 3410, description: ' ' };
  static readonly GREEN_BITS: WebGlConstant = { name: 'GREEN_BITS', value: 3411, description: ' ' };
  static readonly BLUE_BITS: WebGlConstant = { name: 'BLUE_BITS', value: 3412, description: ' ' };
  static readonly ALPHA_BITS: WebGlConstant = { name: 'ALPHA_BITS', value: 3413, description: ' ' };
  static readonly DEPTH_BITS: WebGlConstant = { name: 'DEPTH_BITS', value: 3414, description: ' ' };
  static readonly STENCIL_BITS: WebGlConstant = { name: 'STENCIL_BITS', value: 3415, description: ' ' };
  ...
  static readonly TEXTURE_BINDING_2D: WebGlConstant = { name: 'TEXTURE_BINDING_2D', value: 32873, description: ' ' };
  static readonly SAMPLE_BUFFERS: WebGlConstant = { name: 'SAMPLE_BUFFERS', value: 32936, description: ' ' };
  static readonly SAMPLES: WebGlConstant = { name: 'SAMPLES', value: 32937, description: ' ' };
  ...
  static readonly VENDOR: WebGlConstant = { name: 'VENDOR', value: 7936, description: ' ' };
  static readonly RENDERER: WebGlConstant = { name: 'RENDERER', value: 7937, description: ' ' };
  static readonly VERSION: WebGlConstant = { name: 'VERSION', value: 7938, description: ' ' };
  ...
  static readonly NO_ERROR: WebGlConstant = { name: 'NO_ERROR', value: 0, description: 'Returned from getError.' };
  ...
  static readonly BYTE: WebGlConstant = { name: 'BYTE', value: 5120, description: ' ' };
  static readonly UNSIGNED_BYTE: WebGlConstant = { name: 'UNSIGNED_BYTE', value: 5121, description: ' ' };
  static readonly SHORT: WebGlConstant = { name: 'SHORT', value: 5122, description: ' ' };
  static readonly UNSIGNED_SHORT: WebGlConstant = { name: 'UNSIGNED_SHORT', value: 5123, description: ' ' };
  static readonly INT: WebGlConstant = { name: 'INT', value: 5124, description: ' ' };
  static readonly UNSIGNED_INT: WebGlConstant = { name: 'UNSIGNED_INT', value: 5125, description: ' ' };
  static readonly FLOAT: WebGlConstant = { name: 'FLOAT', value: 5126, description: ' ' };
  static readonly DEPTH_COMPONENT: WebGlConstant = { name: 'DEPTH_COMPONENT', value: 6402, description: ' ' };
  static readonly ALPHA: WebGlConstant = { name: 'ALPHA', value: 6406, description: ' ' };
  static readonly RGB: WebGlConstant = { name: 'RGB', value: 6407, description: ' ' };
  static readonly RGBA: WebGlConstant = { name: 'RGBA', value: 6408, description: ' ' };
  static readonly LUMINANCE: WebGlConstant = { name: 'LUMINANCE', value: 6409, description: ' ' };
  static readonly LUMINANCE_ALPHA: WebGlConstant = { name: 'LUMINANCE_ALPHA', value: 6410, description: ' ' };
  ...
  static readonly MAX_VERTEX_ATTRIBS: WebGlConstant = { name: 'MAX_VERTEX_ATTRIBS', value: 34921, description: ' ' };
  static readonly MAX_VERTEX_UNIFORM_VECTORS: WebGlConstant = {
    name: 'MAX_VERTEX_UNIFORM_VECTORS',
    value: 36347,
    description: ' '
  };
  static readonly MAX_VARYING_VECTORS: WebGlConstant = { name: 'MAX_VARYING_VECTORS', value: 36348, description: ' ' };
  ...
  static readonly SHADER_TYPE: WebGlConstant = { name: 'SHADER_TYPE', value: 35663, description: ' ' };
  static readonly SHADING_LANGUAGE_VERSION: WebGlConstant = {
    name: 'SHADING_LANGUAGE_VERSION',
    value: 35724,
    description: ' '
  };
  static readonly CURRENT_PROGRAM: WebGlConstant = { name: 'CURRENT_PROGRAM', value: 35725, description: ' ' };
  ...
  static readonly KEEP: WebGlConstant = { name: 'KEEP', value: 7680, description: ' ' };
  static readonly REPLACE: WebGlConstant = { name: 'REPLACE', value: 7681, description: ' ' };
  static readonly INCR: WebGlConstant = { name: 'INCR', value: 7682, description: ' ' };
  static readonly DECR: WebGlConstant = { name: 'DECR', value: 7683, description: ' ' };
  static readonly INVERT: WebGlConstant = { name: 'INVERT', value: 5386, description: ' ' };
  static readonly INCR_WRAP: WebGlConstant = { name: 'INCR_WRAP', value: 34055, description: ' ' };
  static readonly DECR_WRAP: WebGlConstant = { name: 'DECR_WRAP', value: 34056, description: ' ' };
  static readonly NEAREST: WebGlConstant = { name: 'NEAREST', value: 9728, description: ' ' };
  static readonly LINEAR: WebGlConstant = { name: 'LINEAR', value: 9729, description: ' ' };
  ...
  static readonly LINEAR_MIPMAP_LINEAR: WebGlConstant = { name: 'LINEAR_MIPMAP_LINEAR', value: 9987, description: ' ' };
  static readonly TEXTURE_MAG_FILTER: WebGlConstant = { name: 'TEXTURE_MAG_FILTER', value: 10240, description: ' ' };
  static readonly TEXTURE_MIN_FILTER: WebGlConstant = { name: 'TEXTURE_MIN_FILTER', value: 10241, description: ' ' };
  static readonly TEXTURE_WRAP_S: WebGlConstant = { name: 'TEXTURE_WRAP_S', value: 10242, description: ' ' };
  static readonly TEXTURE_WRAP_T: WebGlConstant = { name: 'TEXTURE_WRAP_T', value: 10243, description: ' ' };
  static readonly TEXTURE_2D: WebGlConstant = { name: 'TEXTURE_2D', value: 3553, description: ' ' };
  static readonly TEXTURE: WebGlConstant = { name: 'TEXTURE', value: 5890, description: ' ' };
  static readonly TEXTURE_CUBE_MAP: WebGlConstant = { name: 'TEXTURE_CUBE_MAP', value: 34067, description: ' ' };
  ...
  static readonly TEXTURE0: WebGlConstant = { name: 'TEXTURE0', value: 33984, description: 'A texture unit.' };
  static readonly TEXTURE1: WebGlConstant = { name: 'TEXTURE1', value: 33985, description: 'A texture unit.' };
  static readonly TEXTURE2: WebGlConstant = { name: 'TEXTURE2', value: 33986, description: 'A texture unit.' };
  static readonly TEXTURE3: WebGlConstant = { name: 'TEXTURE3', value: 33987, description: 'A texture unit.' };
  static readonly TEXTURE4: WebGlConstant = { name: 'TEXTURE4', value: 33988, description: 'A texture unit.' };
  static readonly TEXTURE5: WebGlConstant = { name: 'TEXTURE5', value: 33989, description: 'A texture unit.' };
  static readonly TEXTURE6: WebGlConstant = { name: 'TEXTURE6', value: 33990, description: 'A texture unit.' };
  static readonly TEXTURE7: WebGlConstant = { name: 'TEXTURE7', value: 33991, description: 'A texture unit.' };
  static readonly TEXTURE8: WebGlConstant = { name: 'TEXTURE8', value: 33992, description: 'A texture unit.' };
  static readonly TEXTURE9: WebGlConstant = { name: 'TEXTURE9', value: 33993, description: 'A texture unit.' };
  static readonly TEXTURE10: WebGlConstant = { name: 'TEXTURE10', value: 33994, description: 'A texture unit.' };
  static readonly TEXTURE11: WebGlConstant = { name: 'TEXTURE11', value: 33995, description: 'A texture unit.' };
  static readonly TEXTURE12: WebGlConstant = { name: 'TEXTURE12', value: 33996, description: 'A texture unit.' };
  static readonly TEXTURE13: WebGlConstant = { name: 'TEXTURE13', value: 33997, description: 'A texture unit.' };
  static readonly TEXTURE14: WebGlConstant = { name: 'TEXTURE14', value: 33998, description: 'A texture unit.' };
  static readonly TEXTURE15: WebGlConstant = { name: 'TEXTURE15', value: 33999, description: 'A texture unit.' };
  static readonly TEXTURE16: WebGlConstant = { name: 'TEXTURE16', value: 34000, description: 'A texture unit.' };
  static readonly TEXTURE17: WebGlConstant = { name: 'TEXTURE17', value: 34001, description: 'A texture unit.' };
  static readonly TEXTURE18: WebGlConstant = { name: 'TEXTURE18', value: 34002, description: 'A texture unit.' };
  static readonly TEXTURE19: WebGlConstant = { name: 'TEXTURE19', value: 34003, description: 'A texture unit.' };
  static readonly TEXTURE20: WebGlConstant = { name: 'TEXTURE20', value: 34004, description: 'A texture unit.' };
  static readonly TEXTURE21: WebGlConstant = { name: 'TEXTURE21', value: 34005, description: 'A texture unit.' };
  static readonly TEXTURE22: WebGlConstant = { name: 'TEXTURE22', value: 34006, description: 'A texture unit.' };
  static readonly TEXTURE23: WebGlConstant = { name: 'TEXTURE23', value: 34007, description: 'A texture unit.' };
  static readonly TEXTURE24: WebGlConstant = { name: 'TEXTURE24', value: 34008, description: 'A texture unit.' };
  static readonly TEXTURE25: WebGlConstant = { name: 'TEXTURE25', value: 34009, description: 'A texture unit.' };
  static readonly TEXTURE26: WebGlConstant = { name: 'TEXTURE26', value: 34010, description: 'A texture unit.' };
  static readonly TEXTURE27: WebGlConstant = { name: 'TEXTURE27', value: 34011, description: 'A texture unit.' };
  static readonly TEXTURE28: WebGlConstant = { name: 'TEXTURE28', value: 34012, description: 'A texture unit.' };
  static readonly TEXTURE29: WebGlConstant = { name: 'TEXTURE29', value: 34013, description: 'A texture unit.' };
  static readonly TEXTURE30: WebGlConstant = { name: 'TEXTURE30', value: 34014, description: 'A texture unit.' };
  static readonly TEXTURE31: WebGlConstant = { name: 'TEXTURE31', value: 34015, description: 'A texture unit.' };
  static readonly ACTIVE_TEXTURE: WebGlConstant = {
    name: 'ACTIVE_TEXTURE',
    value: 34016,
    description: 'The current active texture unit.'
  };
  static readonly REPEAT: WebGlConstant = { name: 'REPEAT', value: 10497, description: ' ' };
  static readonly CLAMP_TO_EDGE: WebGlConstant = { name: 'CLAMP_TO_EDGE', value: 33071, description: ' ' };
  static readonly MIRRORED_REPEAT: WebGlConstant = { name: 'MIRRORED_REPEAT', value: 33648, description: ' ' };
  static readonly FLOAT_VEC2: WebGlConstant = { name: 'FLOAT_VEC2', value: 35664, description: ' ' };
  static readonly FLOAT_VEC3: WebGlConstant = { name: 'FLOAT_VEC3', value: 35665, description: ' ' };
  static readonly FLOAT_VEC4: WebGlConstant = { name: 'FLOAT_VEC4', value: 35666, description: ' ' };
  static readonly INT_VEC2: WebGlConstant = { name: 'INT_VEC2', value: 35667, description: ' ' };
  static readonly INT_VEC3: WebGlConstant = { name: 'INT_VEC3', value: 35668, description: ' ' };
  static readonly INT_VEC4: WebGlConstant = { name: 'INT_VEC4', value: 35669, description: ' ' };
  static readonly BOOL: WebGlConstant = { name: 'BOOL', value: 35670, description: ' ' };
  static readonly BOOL_VEC2: WebGlConstant = { name: 'BOOL_VEC2', value: 35671, description: ' ' };
  static readonly BOOL_VEC3: WebGlConstant = { name: 'BOOL_VEC3', value: 35672, description: ' ' };
  static readonly BOOL_VEC4: WebGlConstant = { name: 'BOOL_VEC4', value: 35673, description: ' ' };
  static readonly FLOAT_MAT2: WebGlConstant = { name: 'FLOAT_MAT2', value: 35674, description: ' ' };
  static readonly FLOAT_MAT3: WebGlConstant = { name: 'FLOAT_MAT3', value: 35675, description: ' ' };
  static readonly FLOAT_MAT4: WebGlConstant = { name: 'FLOAT_MAT4', value: 35676, description: ' ' };
  static readonly SAMPLER_2D: WebGlConstant = { name: 'SAMPLER_2D', value: 35678, description: ' ' };
  static readonly SAMPLER_CUBE: WebGlConstant = { name: 'SAMPLER_CUBE', value: 35680, description: ' ' };
  static readonly LOW_FLOAT: WebGlConstant = { name: 'LOW_FLOAT', value: 36336, description: ' ' };
  static readonly MEDIUM_FLOAT: WebGlConstant = { name: 'MEDIUM_FLOAT', value: 36337, description: ' ' };
  static readonly HIGH_FLOAT: WebGlConstant = { name: 'HIGH_FLOAT', value: 36338, description: ' ' };
  static readonly LOW_INT: WebGlConstant = { name: 'LOW_INT', value: 36339, description: ' ' };
  static readonly MEDIUM_INT: WebGlConstant = { name: 'MEDIUM_INT', value: 36340, description: ' ' };
  static readonly HIGH_INT: WebGlConstant = { name: 'HIGH_INT', value: 36341, description: ' ' };
  static readonly FRAMEBUFFER: WebGlConstant = { name: 'FRAMEBUFFER', value: 36160, description: ' ' };
  static readonly RENDERBUFFER: WebGlConstant = { name: 'RENDERBUFFER', value: 36161, description: ' ' };
  static readonly RGBA4: WebGlConstant = { name: 'RGBA4', value: 32854, description: ' ' };
  static readonly RGB5_A1: WebGlConstant = { name: 'RGB5_A1', value: 32855, description: ' ' };
  static readonly RGB565: WebGlConstant = { name: 'RGB565', value: 36194, description: ' ' };
  static readonly DEPTH_COMPONENT16: WebGlConstant = { name: 'DEPTH_COMPONENT16', value: 33189, description: ' ' };
  static readonly STENCIL_INDEX: WebGlConstant = { name: 'STENCIL_INDEX', value: 6401, description: ' ' };
  static readonly STENCIL_INDEX8: WebGlConstant = { name: 'STENCIL_INDEX8', value: 36168, description: ' ' };
  static readonly DEPTH_STENCIL: WebGlConstant = { name: 'DEPTH_STENCIL', value: 34041, description: ' ' };
  static readonly RENDERBUFFER_WIDTH: WebGlConstant = { name: 'RENDERBUFFER_WIDTH', value: 36162, description: ' ' };
  static readonly RENDERBUFFER_HEIGHT: WebGlConstant = { name: 'RENDERBUFFER_HEIGHT', value: 36163, description: ' ' };
  ...
  static readonly COLOR_ATTACHMENT0: WebGlConstant = { name: 'COLOR_ATTACHMENT0', value: 36064, description: ' ' };
  static readonly DEPTH_ATTACHMENT: WebGlConstant = { name: 'DEPTH_ATTACHMENT', value: 36096, description: ' ' };
  static readonly STENCIL_ATTACHMENT: WebGlConstant = { name: 'STENCIL_ATTACHMENT', value: 36128, description: ' ' };
  static readonly DEPTH_STENCIL_ATTACHMENT: WebGlConstant = {
    name: 'DEPTH_STENCIL_ATTACHMENT',
    value: 33306,
    description: ' '
  };
  static readonly NONE: WebGlConstant = { name: 'NONE', value: 0, description: ' ' };
  ...
  static readonly FRAMEBUFFER_BINDING: WebGlConstant = { name: 'FRAMEBUFFER_BINDING', value: 36006, description: ' ' };
  ...
  static readonly UNPACK_FLIP_Y_WEBGL: WebGlConstant = { name: 'UNPACK_FLIP_Y_WEBGL', value: 37440, description: ' ' };
  ...
  static readonly READ_BUFFER: WebGlConstant = { name: 'READ_BUFFER', value: 3074, description: ' ' };
  static readonly UNPACK_ROW_LENGTH: WebGlConstant = { name: 'UNPACK_ROW_LENGTH', value: 3314, description: ' ' };
  static readonly UNPACK_SKIP_ROWS: WebGlConstant = { name: 'UNPACK_SKIP_ROWS', value: 3315, description: ' ' };
  static readonly UNPACK_SKIP_PIXELS: WebGlConstant = { name: 'UNPACK_SKIP_PIXELS', value: 3316, description: ' ' };
  static readonly PACK_ROW_LENGTH: WebGlConstant = { name: 'PACK_ROW_LENGTH', value: 3330, description: ' ' };
  static readonly PACK_SKIP_ROWS: WebGlConstant = { name: 'PACK_SKIP_ROWS', value: 3331, description: ' ' };
  static readonly PACK_SKIP_PIXELS: WebGlConstant = { name: 'PACK_SKIP_PIXELS', value: 3332, description: ' ' };
  static readonly TEXTURE_BINDING_3D: WebGlConstant = { name: 'TEXTURE_BINDING_3D', value: 32874, description: ' ' };
  static readonly UNPACK_SKIP_IMAGES: WebGlConstant = { name: 'UNPACK_SKIP_IMAGES', value: 32877, description: ' ' };
  static readonly UNPACK_IMAGE_HEIGHT: WebGlConstant = { name: 'UNPACK_IMAGE_HEIGHT', value: 32878, description: ' ' };
  static readonly MAX_3D_TEXTURE_SIZE: WebGlConstant = { name: 'MAX_3D_TEXTURE_SIZE', value: 32883, description: ' ' };
  ...
  static readonly RASTERIZER_DISCARD: WebGlConstant = { name: 'RASTERIZER_DISCARD', value: 35977, description: ' ' };
  ...
  static readonly MAX_ELEMENT_INDEX: WebGlConstant = { name: 'MAX_ELEMENT_INDEX', value: 36203, description: ' ' };
  static readonly RED: WebGlConstant = { name: 'RED', value: 6403, description: ' ' };
  static readonly RGB8: WebGlConstant = { name: 'RGB8', value: 32849, description: ' ' };
  static readonly RGBA8: WebGlConstant = { name: 'RGBA8', value: 32856, description: ' ' };
  static readonly RGB10_A2: WebGlConstant = { name: 'RGB10_A2', value: 32857, description: ' ' };
  static readonly TEXTURE_3D: WebGlConstant = { name: 'TEXTURE_3D', value: 32879, description: ' ' };
  static readonly TEXTURE_WRAP_R: WebGlConstant = { name: 'TEXTURE_WRAP_R', value: 32882, description: ' ' };
  static readonly TEXTURE_MIN_LOD: WebGlConstant = { name: 'TEXTURE_MIN_LOD', value: 33082, description: ' ' };
  static readonly TEXTURE_MAX_LOD: WebGlConstant = { name: 'TEXTURE_MAX_LOD', value: 33083, description: ' ' };
  static readonly TEXTURE_BASE_LEVEL: WebGlConstant = { name: 'TEXTURE_BASE_LEVEL', value: 33084, description: ' ' };
  static readonly TEXTURE_MAX_LEVEL: WebGlConstant = { name: 'TEXTURE_MAX_LEVEL', value: 33085, description: ' ' };
  ...
  static readonly SRGB: WebGlConstant = { name: 'SRGB', value: 35904, description: ' ' };
  static readonly SRGB8: WebGlConstant = { name: 'SRGB8', value: 35905, description: ' ' };
  static readonly SRGB8_ALPHA8: WebGlConstant = { name: 'SRGB8_ALPHA8', value: 35907, description: ' ' };
  static readonly COMPARE_REF_TO_TEXTURE: WebGlConstant = {
    name: 'COMPARE_REF_TO_TEXTURE',
    value: 34894,
    description: ' '
  };
  static readonly RGBA32F: WebGlConstant = { name: 'RGBA32F', value: 34836, description: ' ' };
  static readonly RGB32F: WebGlConstant = { name: 'RGB32F', value: 34837, description: ' ' };
  static readonly RGBA16F: WebGlConstant = { name: 'RGBA16F', value: 34842, description: ' ' };
  static readonly RGB16F: WebGlConstant = { name: 'RGB16F', value: 34843, description: ' ' };
  static readonly TEXTURE_2D_ARRAY: WebGlConstant = { name: 'TEXTURE_2D_ARRAY', value: 35866, description: ' ' };
  static readonly TEXTURE_BINDING_2D_ARRAY: WebGlConstant = {
    name: 'TEXTURE_BINDING_2D_ARRAY',
    value: 35869,
    description: ' '
  };
  static readonly R11F_G11F_B10F: WebGlConstant = { name: 'R11F_G11F_B10F', value: 35898, description: ' ' };
  static readonly RGB9_E5: WebGlConstant = { name: 'RGB9_E5', value: 35901, description: ' ' };
  static readonly RGBA32UI: WebGlConstant = { name: 'RGBA32UI', value: 36208, description: ' ' };
  static readonly RGB32UI: WebGlConstant = { name: 'RGB32UI', value: 36209, description: ' ' };
  static readonly RGBA16UI: WebGlConstant = { name: 'RGBA16UI', value: 36214, description: ' ' };
  static readonly RGB16UI: WebGlConstant = { name: 'RGB16UI', value: 36215, description: ' ' };
  static readonly RGBA8UI: WebGlConstant = { name: 'RGBA8UI', value: 36220, description: ' ' };
  static readonly RGB8UI: WebGlConstant = { name: 'RGB8UI', value: 36221, description: ' ' };
  static readonly RGBA32I: WebGlConstant = { name: 'RGBA32I', value: 36226, description: ' ' };
  static readonly RGB32I: WebGlConstant = { name: 'RGB32I', value: 36227, description: ' ' };
  static readonly RGBA16I: WebGlConstant = { name: 'RGBA16I', value: 36232, description: ' ' };
  static readonly RGB16I: WebGlConstant = { name: 'RGB16I', value: 36233, description: ' ' };
  static readonly RGBA8I: WebGlConstant = { name: 'RGBA8I', value: 36238, description: ' ' };
  static readonly RGB8I: WebGlConstant = { name: 'RGB8I', value: 36239, description: ' ' };
  static readonly RED_INTEGER: WebGlConstant = { name: 'RED_INTEGER', value: 36244, description: ' ' };
  static readonly RGB_INTEGER: WebGlConstant = { name: 'RGB_INTEGER', value: 36248, description: ' ' };
  static readonly RGBA_INTEGER: WebGlConstant = { name: 'RGBA_INTEGER', value: 36249, description: ' ' };
  static readonly R8: WebGlConstant = { name: 'R8', value: 33321, description: ' ' };
  static readonly RG8: WebGlConstant = { name: 'RG8', value: 33323, description: ' ' };
  static readonly R16F: WebGlConstant = { name: 'R16F', value: 33325, description: ' ' };
  static readonly R32F: WebGlConstant = { name: 'R32F', value: 33326, description: ' ' };
  static readonly RG16F: WebGlConstant = { name: 'RG16F', value: 33327, description: ' ' };
  static readonly RG32F: WebGlConstant = { name: 'RG32F', value: 33328, description: ' ' };
  static readonly R8I: WebGlConstant = { name: 'R8I', value: 33329, description: ' ' };
  static readonly R8UI: WebGlConstant = { name: 'R8UI', value: 33330, description: ' ' };
  static readonly R16I: WebGlConstant = { name: 'R16I', value: 33331, description: ' ' };
  static readonly R16UI: WebGlConstant = { name: 'R16UI', value: 33332, description: ' ' };
  static readonly R32I: WebGlConstant = { name: 'R32I', value: 33333, description: ' ' };
  static readonly R32UI: WebGlConstant = { name: 'R32UI', value: 33334, description: ' ' };
  static readonly RG8I: WebGlConstant = { name: 'RG8I', value: 33335, description: ' ' };
  static readonly RG8UI: WebGlConstant = { name: 'RG8UI', value: 33336, description: ' ' };
  static readonly RG16I: WebGlConstant = { name: 'RG16I', value: 33337, description: ' ' };
  static readonly RG16UI: WebGlConstant = { name: 'RG16UI', value: 33338, description: ' ' };
  static readonly RG32I: WebGlConstant = { name: 'RG32I', value: 33339, description: ' ' };
  static readonly RG32UI: WebGlConstant = { name: 'RG32UI', value: 33340, description: ' ' };
  static readonly R8_SNORM: WebGlConstant = { name: 'R8_SNORM', value: 36756, description: ' ' };
  static readonly RG8_SNORM: WebGlConstant = { name: 'RG8_SNORM', value: 36757, description: ' ' };
  static readonly RGB8_SNORM: WebGlConstant = { name: 'RGB8_SNORM', value: 36758, description: ' ' };
  static readonly RGBA8_SNORM: WebGlConstant = { name: 'RGBA8_SNORM', value: 36759, description: ' ' };
  static readonly RGB10_A2UI: WebGlConstant = { name: 'RGB10_A2UI', value: 36975, description: ' ' };
  ...
  static readonly UNSIGNED_INT_24_8: WebGlConstant = { name: 'UNSIGNED_INT_24_8', value: 34042, description: ' ' };
  static readonly HALF_FLOAT: WebGlConstant = { name: 'HALF_FLOAT', value: 5131, description: ' ' };
  static readonly RG: WebGlConstant = { name: 'RG', value: 33319, description: ' ' };
  static readonly RG_INTEGER: WebGlConstant = { name: 'RG_INTEGER', value: 33320, description: ' ' };
  static readonly INT_2_10_10_10_REV: WebGlConstant = { name: 'INT_2_10_10_10_REV', value: 36255, description: ' ' };
  static readonly CURRENT_QUERY: WebGlConstant = { name: 'CURRENT_QUERY', value: 34917, description: ' ' };
  static readonly QUERY_RESULT: WebGlConstant = { name: 'QUERY_RESULT', value: 34918, description: ' ' };
  static readonly QUERY_RESULT_AVAILABLE: WebGlConstant = {
    name: 'QUERY_RESULT_AVAILABLE',
    value: 34919,
    description: ' '
  };
  static readonly ANY_SAMPLES_PASSED: WebGlConstant = { name: 'ANY_SAMPLES_PASSED', value: 35887, description: ' ' };
  static readonly ANY_SAMPLES_PASSED_CONSERVATIVE: WebGlConstant = {
    name: 'ANY_SAMPLES_PASSED_CONSERVATIVE',
    value: 36202,
    description: ' '
  };
  static readonly MAX_DRAW_BUFFERS: WebGlConstant = { name: 'MAX_DRAW_BUFFERS', value: 34852, description: ' ' };
  static readonly DRAW_BUFFER0: WebGlConstant = { name: 'DRAW_BUFFER0', value: 34853, description: ' ' };
  static readonly DRAW_BUFFER1: WebGlConstant = { name: 'DRAW_BUFFER1', value: 34854, description: ' ' };
  static readonly DRAW_BUFFER2: WebGlConstant = { name: 'DRAW_BUFFER2', value: 34855, description: ' ' };
  static readonly DRAW_BUFFER3: WebGlConstant = { name: 'DRAW_BUFFER3', value: 34856, description: ' ' };
  static readonly DRAW_BUFFER4: WebGlConstant = { name: 'DRAW_BUFFER4', value: 34857, description: ' ' };
  static readonly DRAW_BUFFER5: WebGlConstant = { name: 'DRAW_BUFFER5', value: 34858, description: ' ' };
  static readonly DRAW_BUFFER6: WebGlConstant = { name: 'DRAW_BUFFER6', value: 34859, description: ' ' };
  static readonly DRAW_BUFFER7: WebGlConstant = { name: 'DRAW_BUFFER7', value: 34860, description: ' ' };
  static readonly DRAW_BUFFER8: WebGlConstant = { name: 'DRAW_BUFFER8', value: 34861, description: ' ' };
  static readonly DRAW_BUFFER9: WebGlConstant = { name: 'DRAW_BUFFER9', value: 34862, description: ' ' };
  static readonly DRAW_BUFFER10: WebGlConstant = { name: 'DRAW_BUFFER10', value: 34863, description: ' ' };
  static readonly DRAW_BUFFER11: WebGlConstant = { name: 'DRAW_BUFFER11', value: 34864, description: ' ' };
  static readonly DRAW_BUFFER12: WebGlConstant = { name: 'DRAW_BUFFER12', value: 34865, description: ' ' };
  static readonly DRAW_BUFFER13: WebGlConstant = { name: 'DRAW_BUFFER13', value: 34866, description: ' ' };
  static readonly DRAW_BUFFER14: WebGlConstant = { name: 'DRAW_BUFFER14', value: 34867, description: ' ' };
  static readonly DRAW_BUFFER15: WebGlConstant = { name: 'DRAW_BUFFER15', value: 34868, description: ' ' };
  static readonly MAX_COLOR_ATTACHMENTS: WebGlConstant = {
    name: 'MAX_COLOR_ATTACHMENTS',
    value: 36063,
    description: ' '
  };
  static readonly COLOR_ATTACHMENT1: WebGlConstant = { name: 'COLOR_ATTACHMENT1', value: 36065, description: ' ' };
  static readonly COLOR_ATTACHMENT2: WebGlConstant = { name: 'COLOR_ATTACHMENT2', value: 36066, description: ' ' };
  static readonly COLOR_ATTACHMENT3: WebGlConstant = { name: 'COLOR_ATTACHMENT3', value: 36067, description: ' ' };
  static readonly COLOR_ATTACHMENT4: WebGlConstant = { name: 'COLOR_ATTACHMENT4', value: 36068, description: ' ' };
  static readonly COLOR_ATTACHMENT5: WebGlConstant = { name: 'COLOR_ATTACHMENT5', value: 36069, description: ' ' };
  static readonly COLOR_ATTACHMENT6: WebGlConstant = { name: 'COLOR_ATTACHMENT6', value: 36070, description: ' ' };
  static readonly COLOR_ATTACHMENT7: WebGlConstant = { name: 'COLOR_ATTACHMENT7', value: 36071, description: ' ' };
  static readonly COLOR_ATTACHMENT8: WebGlConstant = { name: 'COLOR_ATTACHMENT8', value: 36072, description: ' ' };
  static readonly COLOR_ATTACHMENT9: WebGlConstant = { name: 'COLOR_ATTACHMENT9', value: 36073, description: ' ' };
  static readonly COLOR_ATTACHMENT10: WebGlConstant = { name: 'COLOR_ATTACHMENT10', value: 36074, description: ' ' };
  static readonly COLOR_ATTACHMENT11: WebGlConstant = { name: 'COLOR_ATTACHMENT11', value: 36075, description: ' ' };
  static readonly COLOR_ATTACHMENT12: WebGlConstant = { name: 'COLOR_ATTACHMENT12', value: 36076, description: ' ' };
  static readonly COLOR_ATTACHMENT13: WebGlConstant = { name: 'COLOR_ATTACHMENT13', value: 36077, description: ' ' };
  static readonly COLOR_ATTACHMENT14: WebGlConstant = { name: 'COLOR_ATTACHMENT14', value: 36078, description: ' ' };
  static readonly COLOR_ATTACHMENT15: WebGlConstant = { name: 'COLOR_ATTACHMENT15', value: 36079, description: ' ' };
  static readonly SAMPLER_3D: WebGlConstant = { name: 'SAMPLER_3D', value: 35679, description: ' ' };
  static readonly SAMPLER_2D_SHADOW: WebGlConstant = { name: 'SAMPLER_2D_SHADOW', value: 35682, description: ' ' };
  static readonly SAMPLER_2D_ARRAY: WebGlConstant = { name: 'SAMPLER_2D_ARRAY', value: 36289, description: ' ' };
  static readonly SAMPLER_2D_ARRAY_SHADOW: WebGlConstant = {
    name: 'SAMPLER_2D_ARRAY_SHADOW',
    value: 36292,
    description: ' '
  };
  static readonly SAMPLER_CUBE_SHADOW: WebGlConstant = { name: 'SAMPLER_CUBE_SHADOW', value: 36293, description: ' ' };
  static readonly INT_SAMPLER_2D: WebGlConstant = { name: 'INT_SAMPLER_2D', value: 36298, description: ' ' };
  static readonly INT_SAMPLER_3D: WebGlConstant = { name: 'INT_SAMPLER_3D', value: 36299, description: ' ' };
  static readonly INT_SAMPLER_CUBE: WebGlConstant = { name: 'INT_SAMPLER_CUBE', value: 36300, description: ' ' };
  ...
  static readonly MAX_SAMPLES: WebGlConstant = { name: 'MAX_SAMPLES', value: 36183, description: ' ' };
  static readonly SAMPLER_BINDING: WebGlConstant = { name: 'SAMPLER_BINDING', value: 35097, description: ' ' };
  static readonly PIXEL_PACK_BUFFER: WebGlConstant = { name: 'PIXEL_PACK_BUFFER', value: 35051, description: ' ' };
  static readonly PIXEL_UNPACK_BUFFER: WebGlConstant = { name: 'PIXEL_UNPACK_BUFFER', value: 35052, description: ' ' };
  ...
  static readonly COPY_READ_BUFFER: WebGlConstant = { name: 'COPY_READ_BUFFER', value: 36662, description: ' ' };
  static readonly COPY_WRITE_BUFFER: WebGlConstant = { name: 'COPY_WRITE_BUFFER', value: 36663, description: ' ' };
  ...
  static readonly FLOAT_MAT2x3: WebGlConstant = { name: 'FLOAT_MAT2x3', value: 35685, description: ' ' };
  static readonly FLOAT_MAT2x4: WebGlConstant = { name: 'FLOAT_MAT2x4', value: 35686, description: ' ' };
  static readonly FLOAT_MAT3x2: WebGlConstant = { name: 'FLOAT_MAT3x2', value: 35687, description: ' ' };
  static readonly FLOAT_MAT3x4: WebGlConstant = { name: 'FLOAT_MAT3x4', value: 35688, description: ' ' };
  static readonly FLOAT_MAT4x2: WebGlConstant = { name: 'FLOAT_MAT4x2', value: 35689, description: ' ' };
  static readonly FLOAT_MAT4x3: WebGlConstant = { name: 'FLOAT_MAT4x3', value: 35690, description: ' ' };
  static readonly UNSIGNED_INT_VEC2: WebGlConstant = { name: 'UNSIGNED_INT_VEC2', value: 36294, description: ' ' };
  static readonly UNSIGNED_INT_VEC3: WebGlConstant = { name: 'UNSIGNED_INT_VEC3', value: 36295, description: ' ' };
  static readonly UNSIGNED_INT_VEC4: WebGlConstant = { name: 'UNSIGNED_INT_VEC4', value: 36296, description: ' ' };
  static readonly UNSIGNED_NORMALIZED: WebGlConstant = { name: 'UNSIGNED_NORMALIZED', value: 35863, description: ' ' };
  static readonly SIGNED_NORMALIZED: WebGlConstant = { name: 'SIGNED_NORMALIZED', value: 36764, description: ' ' };
  ...
  static readonly INTERLEAVED_ATTRIBS: WebGlConstant = { name: 'INTERLEAVED_ATTRIBS', value: 35980, description: ' ' };
  static readonly SEPARATE_ATTRIBS: WebGlConstant = { name: 'SEPARATE_ATTRIBS', value: 35981, description: ' ' };
  ...
  static readonly TRANSFORM_FEEDBACK: WebGlConstant = { name: 'TRANSFORM_FEEDBACK', value: 36386, description: ' ' };
  ...
  static readonly FRAMEBUFFER_DEFAULT: WebGlConstant = { name: 'FRAMEBUFFER_DEFAULT', value: 33304, description: ' ' };
  static readonly DEPTH24_STENCIL8: WebGlConstant = { name: 'DEPTH24_STENCIL8', value: 35056, description: ' ' };
  static readonly DRAW_FRAMEBUFFER_BINDING: WebGlConstant = {
    name: 'DRAW_FRAMEBUFFER_BINDING',
    value: 36006,
    description: ' '
  };
  static readonly READ_FRAMEBUFFER: WebGlConstant = { name: 'READ_FRAMEBUFFER', value: 36008, description: ' ' };
  static readonly DRAW_FRAMEBUFFER: WebGlConstant = { name: 'DRAW_FRAMEBUFFER', value: 36009, description: ' ' };
  ...
  static readonly UNIFORM_BUFFER: WebGlConstant = { name: 'UNIFORM_BUFFER', value: 35345, description: ' ' };
  ...
  static readonly UNIFORM_BUFFER_SIZE: WebGlConstant = { name: 'UNIFORM_BUFFER_SIZE', value: 35370, description: ' ' };
  ...
  static readonly UNIFORM_TYPE: WebGlConstant = { name: 'UNIFORM_TYPE', value: 35383, description: ' ' };
  static readonly UNIFORM_SIZE: WebGlConstant = { name: 'UNIFORM_SIZE', value: 35384, description: ' ' };
  static readonly UNIFORM_BLOCK_INDEX: WebGlConstant = { name: 'UNIFORM_BLOCK_INDEX', value: 35386, description: ' ' };
  static readonly UNIFORM_OFFSET: WebGlConstant = { name: 'UNIFORM_OFFSET', value: 35387, description: ' ' };
  ...
  static readonly OBJECT_TYPE: WebGlConstant = { name: 'OBJECT_TYPE', value: 37138, description: ' ' };
  static readonly SYNC_CONDITION: WebGlConstant = { name: 'SYNC_CONDITION', value: 37139, description: ' ' };
  static readonly SYNC_STATUS: WebGlConstant = { name: 'SYNC_STATUS', value: 37140, description: ' ' };
  static readonly SYNC_FLAGS: WebGlConstant = { name: 'SYNC_FLAGS', value: 37141, description: ' ' };
  static readonly SYNC_FENCE: WebGlConstant = { name: 'SYNC_FENCE', value: 37142, description: ' ' };
  static readonly SYNC_GPU_COMMANDS_COMPLETE: WebGlConstant = {
    name: 'SYNC_GPU_COMMANDS_COMPLETE',
    value: 37143,
    description: ' '
  };
  static readonly UNSIGNALED: WebGlConstant = { name: 'UNSIGNALED', value: 37144, description: ' ' };
  static readonly SIGNALED: WebGlConstant = { name: 'SIGNALED', value: 37145, description: ' ' };
  static readonly ALREADY_SIGNALED: WebGlConstant = { name: 'ALREADY_SIGNALED', value: 37146, description: ' ' };
  static readonly TIMEOUT_EXPIRED: WebGlConstant = { name: 'TIMEOUT_EXPIRED', value: 37147, description: ' ' };
  static readonly CONDITION_SATISFIED: WebGlConstant = { name: 'CONDITION_SATISFIED', value: 37148, description: ' ' };
  static readonly WAIT_FAILED: WebGlConstant = { name: 'WAIT_FAILED', value: 37149, description: ' ' };
  static readonly SYNC_FLUSH_COMMANDS_BIT: WebGlConstant = {
    name: 'SYNC_FLUSH_COMMANDS_BIT',
    value: 1,
    description: ' '
  };
  static readonly COLOR: WebGlConstant = { name: 'COLOR', value: 6144, description: ' ' };
  static readonly DEPTH: WebGlConstant = { name: 'DEPTH', value: 6145, description: ' ' };
  static readonly STENCIL: WebGlConstant = { name: 'STENCIL', value: 6146, description: ' ' };
  static readonly MIN: WebGlConstant = { name: 'MIN', value: 32775, description: ' ' };
  static readonly MAX: WebGlConstant = { name: 'MAX', value: 32776, description: ' ' };
  static readonly DEPTH_COMPONENT24: WebGlConstant = { name: 'DEPTH_COMPONENT24', value: 33190, description: ' ' };
  static readonly STREAM_READ: WebGlConstant = { name: 'STREAM_READ', value: 35041, description: ' ' };
  static readonly STREAM_COPY: WebGlConstant = { name: 'STREAM_COPY', value: 35042, description: ' ' };
  static readonly STATIC_READ: WebGlConstant = { name: 'STATIC_READ', value: 35045, description: ' ' };
  static readonly STATIC_COPY: WebGlConstant = { name: 'STATIC_COPY', value: 35046, description: ' ' };
  static readonly DYNAMIC_READ: WebGlConstant = { name: 'DYNAMIC_READ', value: 35049, description: ' ' };
  static readonly DYNAMIC_COPY: WebGlConstant = { name: 'DYNAMIC_COPY', value: 35050, description: ' ' };
  static readonly DEPTH_COMPONENT32F: WebGlConstant = { name: 'DEPTH_COMPONENT32F', value: 36012, description: ' ' };
  static readonly DEPTH32F_STENCIL8: WebGlConstant = { name: 'DEPTH32F_STENCIL8', value: 36013, description: ' ' };
  static readonly INVALID_INDEX: WebGlConstant = { name: 'INVALID_INDEX', value: 4294967295, description: ' ' };
  static readonly TIMEOUT_IGNORED: WebGlConstant = { name: 'TIMEOUT_IGNORED', value: -1, description: ' ' };
  ...
  //  static readonly RGBA32F_EXT: WebGlConstant = { name: "RGBA32F_EXT", value: 34836, description: "RGBA 32-bit floating-point color-renderable format.", extensionName: "WEBGL_color_buffer_float" };
  //  static readonly RGB32F_EXT: WebGlConstant = { name: "RGB32F_EXT", value: 34837, description: "RGB 32-bit floating-point color-renderable format.", extensionName: "WEBGL_color_buffer_float" };
