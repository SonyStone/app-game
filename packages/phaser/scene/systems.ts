...
const GetPhysicsPlugins = require('./GetPhysicsPlugins');
const GetScenePlugins = require('./GetScenePlugins');
...
export class Systems {
   ...
   * @since 3.10.0
   */
  sceneUpdate: (time: number, delta: number) => void = NOOP;
  ...
  init(game: Phaser.Game) {
    ...
    (pluginManager as any).addToScene(this, DefaultPlugins.Global, [
  ...
  render(
    ...
    (this.cameras as any).render(renderer, displayList);
   ...
   * @return {Phaser.Scenes.Systems} This Systems object.
   */
  setActive(value: boolean, data: any) {
    if (value) {
