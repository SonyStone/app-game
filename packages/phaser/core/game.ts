...
class Game {
   ...
   */
  readonly config = new Phaser.Core.Config(config);
   ...
   */
  anims = new Phaser.Animations.AnimationManager(this as any as Phaser.Game);
   ...
   */
  textures = new Phaser.Textures.TextureManager(this as any as Phaser.Game);
   ...
   */
  cache = new Phaser.Cache.CacheManager(this as any as Phaser.Game);
   ...
   */
  registry = new Phaser.Data.DataManager(
    this as any,
   ...
   */
  input = new Phaser.Input.InputManager(this as any, this.config);
   ...
   * @since 3.0.0
   */
  scene = new Phaser.Scenes.SceneManager(this as any, this.config.sceneConfig!);
   ...
   * @since 3.16.0
   */
  scale = new Phaser.Scale.ScaleManager(this as any, this.config);
   ...
   * @since 3.0.0
   */
  sound = typeof FEATURE_SOUND ? SoundManagerCreator.create(this) : null;
   ...
   * @since 3.0.0
   */
  loop = new Phaser.Core.TimeStep(this as any, this.config.fps);
   ...
   * @since 3.0.0
   */
  plugins = new Phaser.Plugins.PluginManager(this, this.config);
   ...
   * @since 3.13.0
   */
  facebook = typeof PLUGIN_FBINSTANT
    ? new Phaser.FacebookInstantGamesPlugin(this as any)
    : null;
   ...
   */
  destroy(removeCanvas: boolean, noReturn = false) {
