...
export const closestCenter: CollisionDetector = (draggable, droppables, context) => {
...
export const closestCorners: CollisionDetector = (draggable, droppables, context) => {
  ...
  for (const droppable of droppables) {
    ...
    const distance =
      distanceBetweenPoints(droppableCorners.topLeft, draggableCorners.topLeft) +
...
export const mostIntersecting: CollisionDetector = (draggable, droppables, context) => {
