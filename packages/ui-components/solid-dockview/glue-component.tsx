...
export function createWatermarkComponent(props: DockViewProps, addExtraRender: AddExtraRender) {
  class WatermarkComponent implements IWatermarkRenderer {
    ...
    init(params: WatermarkRendererInitParameters): void {
      ...
      const jsxRender = () => (
        ...
        >
          {!!props.watermarkComponent && solidCreateComponent(props.watermarkComponent, watermarkProps)}
        </Portal>
      );
...
export function createComponent(props: DockViewProps, addExtraRender: AddExtraRender) {
  return (options: CreateComponentOptions) => new PanelContentRenderer();
}
...
export function createTabComponent(props: DockViewProps, addExtraRender: AddExtraRender) {
  return (options: CreateComponentOptions) => new PanelTabRenderer();
}
