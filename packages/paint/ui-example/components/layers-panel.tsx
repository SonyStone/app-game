...
export const LayersPanel = (props: { isActive?: boolean }) => {
  return (
    <div
      class="absolute -top-full left-full flex w-40 -translate-x-10 flex-col rounded border  border-black bg-white p-1 text-xs transition-transform in-[.active]:translate-x-0"
