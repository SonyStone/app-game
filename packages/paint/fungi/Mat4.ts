...
export class Matrix4 extends Float32Array {
  ...
  invert() {
    Matrix4.invert(null, this);
    return this;
  }

  from_mul(a: any[], b: any[]) {
    let a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3],
  ...
  from_perspective(fovy: number, aspect: number, near: number, far: number) {
  ...
  from_quat_tran_scale(q: any[], v: any[], s: any[]) {
    // Quaternion math
    let x = q[0],
      y = q[1],
      z = q[2],
  ...
  transform_vec4(v: any, out: any = null) {
    let x = v[0],
      y = v[1],
      z = v[2],
      w = v[3];
  ...
  transform_vec3(v: any, out: any = null) {
    let x = v[0],
      y = v[1],
      z = v[2];
    out = out || v;
  ...
  static look_at(eye: any, center: any, up: any, out: any) {
  ...
  static target_to(eye: any, target: any, up: any, out: any) {
    let eyex = eye[0],
      eyey = eye[1],
      eyez = eye[2],
      upx = up[0],
  ...
  static normal_mat3(a: any, out: any) {
    var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3],
  ...
  static mul(a: any, b: any, out: any) {
    var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3],
  ...
  static scale(out: any, x: any, y: any, z: any) {
    out[0] *= x;
    out[1] *= x;
    out[2] *= x;
    out[3] *= x;
  ...
  static transpose(a: any, out: any) {
  ...
  static multiply_vector(mat4: any, v: any) {
  ...
  static transform_vec4(m: any, v: any, out: any = null) {
    var x = v[0],
      y = v[1],
      z = v[2],
      w = v[3];
  ...
  static from_quat(q: any, out: any) {
    // Quaternion math
    var x = q[0],
      y = q[1],
      z = q[2],
  ...
  static from_quat_tran(q: any, v: any, out: any) {
    // Quaternion math
    var x = q[0],
      y = q[1],
      z = q[2],
  ...
  static from_quat_tran_scale(q: any, v: any, s: any, out: any) {
    // Quaternion math
    var x = q[0],
      y = q[1],
      z = q[2],
  ...
  static get_translation(out: any, mat: any) {
    out[0] = mat[12];
    out[1] = mat[13];
    out[2] = mat[14];
    return out;
  ...
  static get_scaling(out: any, mat: any) {
    var m11 = mat[0],
      m12 = mat[1],
      m13 = mat[2],
      m21 = mat[4],
  ...
  //Returns a quaternion representing the rotational component of a transformation matrix. If a matrix is built with
  //fromRotationTranslation, the returned quaternion will be the same as the quaternion originally supplied
  static get_rotation(out: any, mat: any) {
    // Algorithm taken from http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToQuaternion/index.htm
  ...
  static rotate_y(out: any, rad: any) {
    var s = Math.sin(rad),
      c = Math.cos(rad),
      a00 = out[0],
      a01 = out[1],
  ...
  static rotate_x(out: any, rad: any) {
    var s = Math.sin(rad),
      c = Math.cos(rad),
      a10 = out[4],
      a11 = out[5],
  ...
  static rotate_z(out: any, rad: any) {
    var s = Math.sin(rad),
      c = Math.cos(rad),
      a00 = out[0],
      a01 = out[1],
  ...
  static rotate(out: any, rad: any, axis: any) {
    var x = axis[0],
      y = axis[1],
      z = axis[2],
  ...
  static translate(out: any, x: any, y: any, z: any) {
