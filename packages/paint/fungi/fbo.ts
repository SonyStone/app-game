import { GL_CLEAR_MASK, GL_STATIC_VARIABLES } from '@app-game/webgl/static-variables';

import { GL_TEXTURE_MAG_FILTER, GL_TEXTURE_TARGET } from '@app-game/webgl/static-variables/textures';
