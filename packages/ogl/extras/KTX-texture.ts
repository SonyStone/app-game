...
import type { CompressedImage } from '../core/texture';
...
export class KTXTexture extends Texture {
  constructor(
    ...
    { buffer, wrapS = gl.CLAMP_TO_EDGE, wrapT = gl.CLAMP_TO_EDGE, anisotropy = 0, minFilter, magFilter }: KTXTextureOptions = {}
  ) {
    super(gl, {
  ...
  parseBuffer(buffer: ArrayBuffer): this {
...
class KhronosTextureContainer {
  ...
  mipmaps: CompressedImage = [] as CompressedImage;
