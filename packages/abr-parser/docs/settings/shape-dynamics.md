...
> **TypeScript Reference:** See [`src/types.ts`](../../src/types.ts) for `ZShapeDynamics`, `SizeControlType`, `AngleControlType`, `RoundnessControlType`
> **Descriptor Keys:** See [`src/descriptor-keys.ts`](../../src/descriptor-keys.ts) for `ShapeDynamicsKeys`
...
export const ShapeDynamicsKeys = {
  useTipDynamics: 'shapeDynamicsEnabled', // bool
  szJt: 'sizeJitter', // UntF #Prc
  sizeJitterControl: 'sizeJitterControl', // enum
  minDiameter: 'minimumDiameter', // UntF #Prc
  tiltScale: 'tiltScale', // UntF #Prc
  anglJitter: 'angleJitter', // UntF #Prc
  anglJitterControl: 'angleJitterControl', // enum
  rndnJitter: 'roundnessJitter', // UntF #Prc
  rndnJitterControl: 'roundnessJitterControl', // enum
  minRoundness: 'minimumRoundness', // UntF #Prc
  flipXJitter: 'flipXJitter', // bool
  flipYJitter: 'flipYJitter', // bool
  brushProjection: 'brushProjection' // bool
};
```
