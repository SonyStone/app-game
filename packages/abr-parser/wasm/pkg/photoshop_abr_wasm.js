/* @ts-self-types="./photoshop_abr_wasm.d.ts" */
...
export class Archive {
    ...
    constructor(bytes) {
        ...
        const ret = wasm.archive_new(ptr0, len0);
        if (ret[2]) {
     ...
     */
    patch(changes) {
        const ret = wasm.archive_patch(this.__wbg_ptr, changes);
        if (ret[3]) {
     ...
     * @returns {any}
     */
    plane(section, index, slot) {
        const ret = wasm.archive_plane(this.__wbg_ptr, section, index, slot);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    resource_source(resource) {
        const ret = wasm.archive_resource_source(this.__wbg_ptr, resource);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {Uint8Array}
     */
    sample_bytes(section, index) {
        const ret = wasm.archive_sample_bytes(this.__wbg_ptr, section, index);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     * @returns {any}
     */
    sample_image(section, index, max_bytes) {
        const ret = wasm.archive_sample_image(this.__wbg_ptr, section, index, max_bytes);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    snapshot() {
        const ret = wasm.archive_snapshot(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function compose_document(input) {
    const ret = wasm.compose_document(input);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function create_computed(brushes) {
    const ret = wasm.create_computed(brushes);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {any}
 */
export function decode_resource(source, max_bytes) {
    const ret = wasm.decode_resource(source, max_bytes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function decode_sample(bytes, layout) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_sample(ptr0, len0, layout);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function parse_document(bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function read_library(bytes, max_bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.read_library(ptr0, len0, max_bytes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function resolve_resources(resources, brush) {
    const ret = wasm.resolve_resources(resources, brush);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function write_document(document) {
    const ret = wasm.write_document(document);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./photoshop_abr_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('photoshop_abr_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
