import type { BitSet, ReadonlyBitSet } from './collections/bit-set';
import { SparseSet, createSparseSet } from './collections/sparse-set';
...
export function traverseArchetypeGraph(
  ...
  callback: (archetype: InternalArchetype) => boolean | void,
  traversed = new Set<InternalArchetype>()
): boolean {
