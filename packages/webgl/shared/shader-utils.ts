 ...
 */
function getBindPointForSamplerType(
  _: Partial<WebGLRenderingContext>,
  type: GL_DATA_TYPE
) {
...
function floatSetter(
  gl: Pick<WebGLRenderingContext, "uniform1f">,
...
function floatArraySetter(
  gl: Pick<WebGLRenderingContext, "uniform1fv">,
  location: WebGLUniformLocation
) {
...
function floatVec2Setter(
  gl: Pick<WebGLRenderingContext, "uniform2fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatVec3Setter(
  gl: Pick<WebGLRenderingContext, "uniform3fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatVec4Setter(
  gl: Pick<WebGLRenderingContext, "uniform4fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function intSetter(
  gl: Pick<WebGLRenderingContext, "uniform1i">,
  location: WebGLUniformLocation
) {
  return function (v: number) {
...
function intArraySetter(
  gl: Pick<WebGLRenderingContext, "uniform1iv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function intVec2Setter(
  gl: Pick<WebGLRenderingContext, "uniform2iv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function intVec3Setter(
  gl: Pick<WebGLRenderingContext, "uniform3iv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function intVec4Setter(
  gl: Pick<WebGLRenderingContext, "uniform4iv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function uintSetter(
  gl: Pick<WebGL2RenderingContextBase, "uniform1ui">,
  location: WebGLUniformLocation
) {
  return function (v: number) {
...
function uintArraySetter(
  gl: Pick<WebGL2RenderingContextBase, "uniform1uiv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function uintVec2Setter(
  gl: Pick<WebGL2RenderingContextBase, "uniform2uiv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function uintVec3Setter(
  gl: Pick<WebGL2RenderingContextBase, "uniform3uiv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function uintVec4Setter(
  gl: Pick<WebGL2RenderingContextBase, "uniform4uiv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat2Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix2fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat3Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix3fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat4Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix4fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat23Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix2x3fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat32Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix3x2fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat24Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix2x4fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat42Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix4x2fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat34Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix3x4fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function floatMat43Setter(
  gl: Pick<WebGL2RenderingContext, "uniformMatrix4x3fv">,
  location: WebGLUniformLocation
) {
  return function (v: Iterable<number>) {
...
function samplerSetter(
  gl: Pick<
    ...
    "bindSampler" | "uniform1i" | "activeTexture" | "bindTexture"
  >,
  type: GL_DATA_TYPE,
  unit: number,
  location: WebGLUniformLocation
  ...
  return function (
    textureOrPair:
      | WebGLTexture
      | { texture: WebGLTexture | null; sampler: WebGLSampler | null }
  ) {
    let texture;
...
function samplerArraySetter(
  gl: Pick<
    WebGL2RenderingContext,
    "uniform1iv" | "bindSampler" | "uniform1i" | "activeTexture" | "bindTexture"
  >,
  type: GL_DATA_TYPE,
  unit: number,
  location: WebGLUniformLocation,
...
function intAttribSetter(
  gl: Pick<
    WebGL2RenderingContext,
    "bindBuffer" | "enableVertexAttribArray" | "vertexAttribIPointer"
  >,
  index: number
) {
  return function (b: {
...
function createUniformSetters(
  ...
  function createUniformSetter(
    program: WebGLProgram,
    uniformInfo: { name: string; size: number; type: GL_DATA_TYPE }
  ) {
