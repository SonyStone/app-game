import { GL_SHADER_TYPE, GL_STATIC_VARIABLES } from '@webgl/static-variables';
import { GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER, GL_TEXTURE_WRAP_MODE } from '@webgl/static-variables/textures';
