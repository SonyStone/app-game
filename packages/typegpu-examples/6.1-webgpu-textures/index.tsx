...
import { createTestTexture } from './createTestTexture';
import { shaders } from './shaders';

export default function WebGPUTextures() {
  ...
  return (
    <>
      ...
      <div class="flex flex-col place-content-start gap-2 p-2">
        <a href="https://webgpufundamentals.org/webgpu/lessons/webgpu-textures.html">WebGPU Textures</a>
...
function App(props: {
  ...
  const texture = root['~unstable']
    .createTexture({
      size: [testTexture.width, testTexture.height],
      format: 'rgba8unorm'
    })
    .$usage('sampled');
  texture.write(testTexture.data);
