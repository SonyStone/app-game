...
export class Vec2 extends Vec2Builder(Array) {
   ...
   **/
  static readonly MIN = this.splat(Number.MIN_VALUE);

  /**
   * All `Number.MAX_VALUE`
   * */
  static readonly MAX = this.splat(Number.MAX_VALUE);
}
...
export class UVec2 extends Vec2Builder(Uint32Array) {
   ...
   * All `0`.
   **/
  static readonly MIN = this.splat(0);

  /**
   * All `4294967295`
   * */
  static readonly MAX = this.splat(4294967295);
}
