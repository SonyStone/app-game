...
//#endregion
//#region ../../node_modules/.pnpm/solid-js@1.9.12/node_modules/solid-js/types/jsx.d.ts
/**
...
declare namespace JSX {
  ...
  type Element = Node | ArrayElement | (string & {}) | number | boolean | null | undefined; // END - difference between `jsx.d.ts` and `jsx-h.d.ts`
  ...
  type DirectiveFunctionAttributes<T> = { // it isn't a function
  ...
  type OnCaptureAttributes<T> = { [Key in keyof CustomCaptureEvents as `oncapture:${Key}`]?: EventHandler<T, CustomCaptureEvents[Key]> }; // events
  /**
  ...
  interface WindowEventMap<T> {
    ...
    onPageHide?: EventHandlerUnion<T, PageTransitionEvent> | undefined; // TODO `PageRevealEvent` is currently undefined on TS
    onPageReveal?: EventHandlerUnion<T, Event> | undefined;
    onPageShow?: EventHandlerUnion<T, PageTransitionEvent> | undefined; // TODO `PageSwapEvent` is currently undefined on TS
    ...
    onoffline?: EventHandlerUnion<T, Event> | undefined;
    ononline?: EventHandlerUnion<T, Event> | undefined;
    onpagehide?: EventHandlerUnion<T, PageTransitionEvent> | undefined; // TODO `PageRevealEvent` is currently undefined in TS
    onpagereveal?: EventHandlerUnion<T, Event> | undefined;
    onpageshow?: EventHandlerUnion<T, PageTransitionEvent> | undefined; // TODO `PageSwapEvent` is currently undefined in TS
    onpageswap?: EventHandlerUnion<T, Event> | undefined;
    onpopstate?: EventHandlerUnion<T, PopStateEvent> | undefined;
    onrejectionhandled?: EventHandlerUnion<T, PromiseRejectionEvent> | undefined;
    onstorage?: EventHandlerUnion<T, StorageEvent> | undefined;
    ...
    "on:pagehide"?: EventHandlerWithOptionsUnion<T, PageTransitionEvent> | undefined; // TODO `PageRevealEvent` is currently undefined in TS
    "on:pagereveal"?: EventHandlerWithOptionsUnion<T, Event> | undefined;
    "on:pageshow"?: EventHandlerWithOptionsUnion<T, PageTransitionEvent> | undefined; // TODO `PageSwapEvent` is currently undefined in TS
  ...
  interface CustomEventHandlersCamelCase<T> {
    ...
    onClose?: EventHandlerUnion<T, Event> | undefined; // TODO `CommandEvent` is currently undefined in TS
    ...
    onScrollEnd?: EventHandlerUnion<T, Event> | undefined; // todo `SnapEvent` is currently undefined in TS
    onScrollSnapChange?: EventHandlerUnion<T, Event> | undefined; // todo `SnapEvent` is currently undefined in TS
  ...
  interface CustomEventHandlersNamespaced<T> {
    ...
    "on:close"?: EventHandlerWithOptionsUnion<T, Event> | undefined; // TODO `CommandEvent` is currently undefined in TS
    ...
    "on:scrollend"?: EventHandlerWithOptionsUnion<T, Event> | undefined; // todo `SnapEvent` is currently undefined in TS
    "on:scrollsnapchange"?: EventHandlerWithOptionsUnion<T, Event> | undefined; // todo `SnapEvent` is currently undefined in TS
  ...
  interface DOMAttributes<T> extends CustomAttributes<T>, DirectiveAttributes, DirectiveFunctionAttributes<T>, PropAttributes, AttrAttributes, BoolAttributes, OnAttributes<T>, OnCaptureAttributes<T>, CustomEventHandlersCamelCase<T>, CustomEventHandlersLowerCase<T>, CustomEventHandlersNamespaced<T>, AriaAttributes {
    ...
    // properties
    innerHTML?: string;
    textContent?: string | number; // attributes
  ...
  type HTMLLinkAs = "audio" | "document" | "embed" | "fetch" | "font" | "image" | "object" | "script" | "style" | "track" | "video" | "worker"; // All the WAI-ARIA 1.1 attributes from https://www.w3.org/TR/wai-aria-1.1/
  ...
  interface HTMLAttributes<T> extends DOMAttributes<T> {
    ...
    exportParts?: string | undefined;
    inputMode?: "none" | "text" | "tel" | "url" | "email" | "numeric" | "decimal" | "search" | undefined; // Microdata
    ...
    itemRef?: string | undefined;
    itemScope?: boolean | undefined;
    itemType?: string | undefined; // RDFa Attributes
  ...
  interface InputHTMLAttributes<T> extends HTMLAttributes<T> {
    ...
    required?: boolean | undefined; // https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/search#results
  ...
  interface WebViewHTMLAttributes<T> extends HTMLAttributes<T> {
    ...
    webpreferences?: string | undefined; // does this exists?
    allowfullscreen?: boolean | undefined;
  ...
  interface AnimationElementSVGAttributes<T> extends CoreSVGAttributes<T>, ExternalResourceSVGAttributes, ConditionalProcessingSVGAttributes {
    ...
    onbegin?: EventHandlerUnion<T, Event> | undefined;
    "on:begin"?: EventHandlerWithOptionsUnion<T, Event> | undefined; // TODO TimeEvent is currently undefined on TS
    onEnd?: EventHandlerUnion<T, Event> | undefined;
    onend?: EventHandlerUnion<T, Event> | undefined;
    "on:end"?: EventHandlerWithOptionsUnion<T, Event> | undefined; // TODO TimeEvent is currently undefined on TS
...
type MarkdownRuntimeComponents = Record<string, any> & {
  wrapper?: (props: {
...
declare function renderMarkdownDocument(nodes: MarkdownComponentNode[], props?: MarkdownRuntimeProps): JSX.Element;
//#endregion
export { MarkdownComponentNode, MarkdownRuntimeComponents, MarkdownRuntimeProps, renderMarkdownDocument };