...
/** TextureMagFilter */
export enum GL_TEXTURE_MAG_FILTER {
  NEAREST = GL_CONST.NEAREST,
  LINEAR = GL_CONST.LINEAR,
}

/* TextureMinFilter */
export enum GL_TEXTURE_MIN_FILTER {
  NEAREST = GL_CONST.NEAREST,
  LINEAR = GL_CONST.LINEAR,
...
/** TextureWrapMode */
export enum GL_TEXTURE_WRAP_MODE {
...
export enum GL_TEXTURE_PARAMETER_NAME {
  /**
