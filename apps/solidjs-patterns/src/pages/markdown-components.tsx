...
type MarkdownComponentOverrides = Record<string, unknown>;

export function createPatternMarkdownComponents<T extends MarkdownComponentOverrides>(overrides?: T) {
  return {
    Page(props: PatternLayoutProps): JSX.Element {
      return <PatternLayout {...props} />;
    },
    Section(props: PatternSectionProps): JSX.Element {
