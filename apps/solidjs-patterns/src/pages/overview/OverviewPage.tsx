            ...
            <section>
              ...
              <div class="space-y-2 rounded-xl border border-stone-300 bg-stone-100/80 p-5 text-xs text-stone-600 dark:border-neutral-800 dark:bg-neutral-900/50 dark:text-neutral-400">
                <p>
                  ...
                  SolidJS tracks reactive dependencies at the signal level - components don't re-render; only the parts
                  of the DOM that depend on a changed signal update.
                </p>
                <p>
                  <span class="font-semibold text-stone-800 dark:text-neutral-300">No virtual DOM: </span>
                  Compiled to real DOM operations. JSX runs once at creation time; reactivity is achieved through
                  signals and effects, not diffing.
                </p>
                <p>
