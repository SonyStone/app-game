import { Show, createSignal, createEffect, onCleanup, ComponentProps } from 'solid-js';
...
declare module 'solid-js' {
  namespace JSX {
    interface IntrinsicElements {
      'brush-editor': ComponentProps<'div'>;
    }
  }
}
...
export function BrushEditor(props: BrushEditorProps) {
  ...
  return (
    <brush-editor class="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={props.onCancel}>
      <div
