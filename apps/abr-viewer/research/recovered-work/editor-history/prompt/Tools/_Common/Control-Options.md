...
| Set Name           | Options                                               |
| ------------------ | ----------------------------------------------------- |
| `SizeControl`      | Off, Fade, Dial, Pen Pressure, Pen Tilt, Stylus Wheel |
| `AngleControl`     | SizeControl + Rotation, Initial Direction, Direction  |
| `RoundnessControl` | SizeControl + Rotation                                |
...
The Stylus Wheel control is extremely rare - only available on Wacom Airbrush styli. Consider showing informational tooltip explaining this is specialized hardware.
