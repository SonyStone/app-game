...
export function processAtlas(gl: WebGLRenderingContext, data: UnpackedBMP): ExtWebGLTexture {
  ...
  gl.texParameteri(GL_TEXTURES.TEXTURE_2D, GL_STATIC_VARIABLES.TEXTURE_MAG_FILTER, GL_STATIC_VARIABLES.NEAREST);
  gl.texParameteri(GL_TEXTURES.TEXTURE_2D, GL_STATIC_VARIABLES.TEXTURE_MIN_FILTER, GL_STATIC_VARIABLES.NEAREST);
